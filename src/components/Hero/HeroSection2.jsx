...
const HeroSection2 = () => {
  ...
  return (
    <>
      ...
      >
        <div className="hero__container !w-[700px]">
          <div className="hero__container__flex !gap-[5rem]">
            <motion.div className="hero__content">
              <motion.h1 className="hero__content__title !text-[3.2rem]">
                <TypeAnimation
                  custom={1}
                  initial="hidden"
                  whileInView="visible"
              ...
              <motion.p
                ...
                transition={{ duration: 0.5, delay: 0.25 }}
              >
                Здесь Вы сможете ознакомиться с моим резюме, ссылками на проекты
                и социальные сети.
              </motion.p>
